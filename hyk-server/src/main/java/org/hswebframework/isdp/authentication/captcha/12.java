...
//
//    private static ReactiveCache<String> cache;
//
//    public ReactiveCache<String> getCache() {
//        if (cache != null) {
//            return cache;
//        }
...
//
//        return getCache().mono("captcha:" + key)
//				.onCacheMissResume(Mono.just(captcha.text()))
//				.cache(properties.getTtl())
...
//
//
//        getCache().getAll(redisKey).subscribe(strings -> System.out.println("sdsds="+strings));
//        event.async(
//                getCache().getMono(redisKey)
//						.map(s -> {
//                                    System.out.println("sdskdjskldjaskdjk"+s);
//                                    return s.equalsIgnoreCase(s);
//                                }
//						        )
//				                .defaultIfEmpty(false)
//				                .flatMap(checked -> cache.getMono(redisKey)
